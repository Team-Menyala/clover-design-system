...
export default function Home() {
  return (
    <div className="flex items-center justify-center flex-col min-h-screen p-8 py-8 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 items-center text-center max-w-screen-md">
        <div className="flex flex-col gap-3 items-center">
          <svg className="w-12 h-12 clover-spin" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
